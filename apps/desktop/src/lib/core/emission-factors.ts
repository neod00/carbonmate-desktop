...
export const MATERIAL_EMISSION_FACTORS: MaterialEmissionFactor[] = [
    ...
    // PR-V03: 산업 화학물질 — 강철 일괄 fallback 차단 + 키워드 추론 대상.
    // 값은 보수적 추정 (ecoinvent v3.x global average); 정확한 산정에는 사용자 override 권장.
    {
        id: 'material_chem_naoh',
        name: 'Sodium hydroxide (NaOH, 100%)',
        nameKo: '수산화나트륨 (NaOH, 100% 기준)',
        value: 1.12,
        unit: 'kgCO2e/kg',
        sourceType: 'fossil',
        source: 'ecoinvent v3.x (global)',
        year: 2024,
        geographicScope: 'Global',
        uncertainty: 25,
        category: 'Chemicals',
        subcategory: 'Inorganic alkali'
    },
    {
        id: 'material_chem_h2so4',
        name: 'Sulfuric acid (H2SO4, 100%)',
        nameKo: '황산 (H₂SO₄, 100% 기준)',
        value: 0.18,
        unit: 'kgCO2e/kg',
        sourceType: 'fossil',
        source: 'ecoinvent v3.x (global)',
        ...
        uncertainty: 30,
        category: 'Chemicals',
        subcategory: 'Inorganic acid'
    },
    {
        id: 'material_chem_h2o2',
        name: 'Hydrogen peroxide (H2O2, 100%)',
        nameKo: '과산화수소 (H₂O₂, 100% 기준)',
        value: 1.5,
        unit: 'kgCO2e/kg',
        sourceType: 'fossil',
        source: 'ecoinvent v3.x (global)',
        ...
        uncertainty: 25,
        category: 'Chemicals',
        subcategory: 'Inorganic oxidant'
    },
    {
        id: 'material_chem_nh3',
        name: 'Ammonia (NH3)',
        nameKo: '암모니아 (NH₃)',
        value: 2.1,
        unit: 'kgCO2e/kg',
    ...
    {
        id: 'material_chem_pac',
        name: 'Polyaluminium chloride (PAC) / flocculant',
        nameKo: '응집제 (PAC/폴리머)',
        value: 0.6,
        unit: 'kgCO2e/kg',
        sourceType: 'fossil',
    ...
    {
        id: 'material_chem_purified_water',
        name: 'Purified / process water',
        nameKo: '정제수 / 공정용수',
        value: 0.0003,
        unit: 'kgCO2e/kg',
        sourceType: 'fossil',
        source: 'ecoinvent v3.x',
        year: 2024,
        geographicScope: 'Korea',
        uncertainty: 30,
        category: 'Chemicals',
    ...
    {
        id: 'material_chem_industrial_water',
        name: 'Industrial water (m3)',
        nameKo: '공업용수 (m³ 기준)',
        value: 0.3,
        unit: 'kgCO2e/m³',
        sourceType: 'fossil',
    ...
    {
        id: 'material_chem_nickel_sulfate_crude',
        name: 'Crude nickel sulfate (intermediate)',
        nameKo: '조황산니켈 (중간재)',
        value: 5.0,
        unit: 'kgCO2e/kg',
        sourceType: 'fossil',
        source: 'literature estimate (보수)',
        year: 2024,
        geographicScope: 'Global',
        uncertainty: 40,
        category: 'Chemicals',
        subcategory: 'Metal compound'
    }
]
