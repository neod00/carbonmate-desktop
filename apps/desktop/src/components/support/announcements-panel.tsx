...
export function AnnouncementsPanel({ open, onClose, onAllRead }: AnnouncementsPanelProps) {
    ...
    return (
        <>
            ...
            />
            <div
                className="fixed top-0 right-0 h-screen w-full max-w-md border-l-2 border-primary/40 shadow-2xl z-50 flex flex-col"
                        ...
                        <ul className="space-y-3">
                            {items.map(a => {
                                ...
                                return (
                                    <li
                                        key={a.id}
                                        className={`rounded-lg border-2 ${style.border} ${style.bg} p-4 shadow-sm`}
                                    >
